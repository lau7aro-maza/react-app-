export const products =
    [{name:"Corbata", price:100, stock:10, id:1, img:'https://previews.123rf.com/images/yupiramos/yupiramos1706/yupiramos170619294/80334156-corbata-elegante-aislado-icono-de-ilustraci%C3%B3n-vectorial-de-dise%C3%B1o.jpg', category:"indumentaria"},
    {name:"Pantalon", price:850, stock:22, id:2, img:'https://media.istockphoto.com/vectors/pants-cartoon-vector-id1076492576', category:"indumentaria"},
    {name:"Gorra", price:100, stock:5, id:3, img:'https://cdn.solodeportes.com.ar/media/catalog/product/cache/faae2c37ab1d315e4b697a7f62b421b7/g/o/gorra-nike-legacy-91-tech-negra-51104bv01076010-1.jpg', category:"accesories"},
    ...
    {name:"Camisa", price:700, stock:15, id:5, img:'https://us.123rf.com/450wm/redrockerz/redrockerz1601/redrockerz160100016/50854987-camisa-de-ilustraci%C3%B3n-de-bosquejo-del-dise%C3%B1o.jpg?ver=6', category:"indumentaria"},
    {name:"Chaqueta", price:900, stock:8, id:6, img:'https://m.media-amazon.com/images/I/61cmifc3sLL._AC_UX342_.jpg', category:"indumentaria"},
    ...
    {name:"Musculosa", price:500, stock:10, id:9, img:'https://http2.mlstatic.com/D_NQ_NP_681574-MLA31598844640_072019-O.jpg', category:"indumentaria"},
    ...
    {name:"Campera", price:3500, stock:10, id:15, img:'https://scandinavian.com.ar/media/catalog/product/cache/84501bf2af75e659022a456946bd3e2c/1/8/1823161_010_f_1_2.jpg', category:"indumentaria"}]


export const traerProducto = (categoryId) => {
    return new Promise((resolve, reject) => {
        const productosFiltrados = products.filter((producto) =>producto.category === categoryId)
        setTimeout(() => {
...
export const traerProduct = (id) => {
    return new Promise((resolve, reject) => {
        const productoSeleccionado = products.find((producto) => producto.id === Number(id));
        setTimeout(() => {
